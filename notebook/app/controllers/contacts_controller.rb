class ContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact.save
        format.html { redirect_to @contact, notice: I18n.t('messages.contact.created') }
  ...
  def update
    respond_to do |format|
      if @contact.update(contact_params)
        format.html { redirect_to contacts_path, notice: I18n.t('messages.contact.updated') }
  ...
  def destroy
    @contact.destroy
    respond_to do |format|
      format.html { redirect_to contacts_url, notice: I18n.t('messages.contact.destroyed') }
